<!-- ⚠️ This README has been generated from the file(s) ".config/docs/blueprint-readme-cli.md" ⚠️--><div align="center">
  <center>
    <a href="https://github.com/ProfessorManhattan/mblabs">
      <img width="148" height="148" alt="MBLabs logo" src="https://gitlab.com/megabyte-labs/npm/cli/mblabs/-/raw/master/logo.png" />
    </a>
  </center>
</div>
<div align="center">
  <center><h1 align="center"><i></i>MBLabs - A Megabyte Labs Tool<i></i></h1></center>
...
<div align="center">
  ...
  <a href="https://github.com/ProfessorManhattan/mblabs/blob/master/docs/CONTRIBUTING.md" title="Learn about contributing" target="_blank">
    <img alt="Contributing" src="https://img.shields.io/badge/Contributing-Guide-0074D9?logo=github-sponsors&logoColor=white&style=for-the-badge" />
  </a>
  <a href="https://app.slack.com/client/T01ABCG4NK1/C01NN74H0LW/details/" title="Chat with us on Slack" target="_blank">
    <img alt="Slack" src="https://img.shields.io/badge/Slack-Chat-e01e5a?logo=slack&logoColor=white&style=for-the-badge" />
  </a>
  <a href="https://github.com/ProfessorManhattan/mblabs" title="GitHub mirror" target="_blank">
    <img alt="GitHub" src="https://img.shields.io/badge/Mirror-GitHub-333333?logo=github&style=for-the-badge" />
  </a>
  <a href="https://gitlab.com/megabyte-labs/npm/cli/mblabs" title="GitLab repository" target="_blank">
...
<div align="center">
  ...
  <a href="https://snyk.io/advisor/npm-package/mblabs" title="Number of vulnerabilities from Snyk scan on mblabs" target="_blank">
    <img alt="Number of vulnerabilities from Snyk scan on mblabs" src="https://img.shields.io/snyk/vulnerabilities/npm/mblabs?style=flat-square&logo=snyk&logoColor=white" />
  </a>
  <a href="website.documentation/npm" target="_blank">
    <img alt="Documentation" src="https://img.shields.io/badge/documentation-yes-brightgreen.svg?logo=readthedocs&logoColor=white&style=flat-square" />
  </a>
  <a href="https://github.com/ProfessorManhattan/mblabs/blob/master/LICENSE" target="_blank">
    <img alt="License: MIT" src="https://img.shields.io/badge/license-MIT-yellow.svg?logo=data:image/png;base64,&style=flat-square" />
  </a>
</div>

> </br><h4 align="center">**A CLI that provides various miscellaneous functions used in the Megabyte Labs ecosystem**</h4></br>
...
**MBLabs** is a CLI made with [Nest.js](https://nestjs.com/) and [Nest.js Commander](https://docs.nestjs.com/recipes/nest-commander). It performs miscellaneous tasks that do not quite fit in other projects. For instance, it:
...
Other versions may work, but only the above versions are supported. Most development dependencies are installed automatically by our `Taskfile.yml` set-up (even Node.js and Python). Run `bash start.sh` to install **[Bodega](https://github.com/ProfessorManhattan/Bodega)** (an improved fork of [go-task](https://github.com/go-task/task)) and run the initialization sequence. The taskfiles will automatically install dependencies as they are needed, based on what development tasks you are running. For more information, check out the [CONTRIBUTING.md](https://github.com/ProfessorManhattan/mblabs/blob/main/docs/CONTRIBUTING.md) or simply run:
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/ProfessorManhattan/mblabs/issues). If you would like to contribute, please take a look at the [contributing guide](https://github.com/ProfessorManhattan/mblabs/blob/master/docs/CONTRIBUTING.md).
...
Copyright © 2020-2021 [Megabyte LLC](https://megabyte.space). This project is [MIT](https://gitlab.com/megabyte-labs/npm/cli/mblabs/-/blob/master/LICENSE) licensed.
