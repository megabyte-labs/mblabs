...
# @description This script will install MBLabs. The script heavily borrows from
...
#
#   ```
#   curl -sSL https://raw.githubusercontent.com/megabyte-labs/mblabs/master/local/install.sh | sh
#   ```

RELEASES_URL="https://github.com/megabyte-labs/mblabs/releases"
